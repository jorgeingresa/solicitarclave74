...
//Inicio Archivos Globales
include(RelativePath . "/global_general.php");
//Fin Archivos Globales

//Connection Settings @0-541E7C78
$CCConnectionSettings = array (
    "usuarios_extranet" => array(
        "Type" => "PostgreSQL",
        "DBLib" => "PostgreSQL",
        "Database" => "usuarios",
        "Host" => "172.19.119.13",
...
//Initialize Common Variables @0-3A61107B
...
$CCSLocales->AddLocale("es-CL", Array("es", "CL", array(1, 0, ""), 2, ",", ".", array("Enero", "Febrero", "Marzo", "Abril", "Mayo", "Junio", "Julio", "Agosto", "Septiembre", "Octubre", "Noviembre", "Diciembre"), array("Ene", "Feb", "Mar", "Abr", "May", "Jun", "Jul", "Ago", "Sep", "Oct", "Nov", "Dic"), array("Domingo", "Lunes", "Martes", "Miércoles", "Jueves", "Viernes", "Sábado"), array("Dom", "Lun", "Mar", "Mié", "Jue", "Vie", "Sáb"), array("D", "L", "M", "M", "J", "V", "S"), array("dd", "-", "mm", "-", "yyyy"), array("dddd", ", ", "dd", " de ", "mmmm", " de ", "yyyy"), array("H", ":", "nn"), array("H", ":", "nn", ":", "ss"), "", "", 0, false, "", "utf-8", "UTF-8"));
...
//usuarios_extranet Connection Class @-2AB9F32F
class clsDBusuarios_extranet extends DB_Adapter
{
    ...
    function Initialize()
    {
        ...
        $this->SetProvider($CCConnectionSettings["usuarios_extranet"]);
        parent::Initialize();
...
//End usuarios_extranet Connection Class
